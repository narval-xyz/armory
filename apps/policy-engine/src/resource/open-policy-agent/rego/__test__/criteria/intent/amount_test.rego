...
test_checkIntentAmount {
	checkIntentAmount({"operator": operators.equal, "value": one_matic}) with input as request
		with data.entities as entities

	checkIntentAmount({"operator": operators.notEqual, "value": ten_matic}) with input as request
		with data.entities as entities

	checkIntentAmount({"operator": operators.greaterThan, "value": half_matic}) with input as request
		with data.entities as entities

	checkIntentAmount({"operator": operators.lessThan, "value": ten_matic}) with input as request
		with data.entities as entities

	checkIntentAmount({"operator": operators.greaterThanOrEqual, "value": one_matic}) with input as request
		with data.entities as entities

	checkIntentAmount({"operator": operators.lessThanOrEqual, "value": one_matic}) with input as request
		with data.entities as entities
}
