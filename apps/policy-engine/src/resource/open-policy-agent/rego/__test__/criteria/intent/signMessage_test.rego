...
test_checkSignMessage {
	...
	checkIntentMessage({"operator": operators.contains, "value": "Hello"}) with input as signMessageRequest with data.entities as entities
}
...
test_checkSignRawPayload {
	...
	checkIntentPayload({"operator": operators.contains, "value": "Hello"}) with input as signRawPayloadRequest with data.entities as entities
