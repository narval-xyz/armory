...
test_checkLegacyGasFeeAmount {
  ...
  legacyLessGasFee = legacyGasFee - 1000000000
	checkGasFeeAmount({"operator": operators.equal, "value": legacyGasFee}) with input as legacyReq with data.entities as entities
	checkGasFeeAmount({"operator": operators.notEqual, "value": legacyMoreGasFee}) with input as legacyReq with data.entities as entities
	checkGasFeeAmount({"operator": operators.greaterThan, "value": legacyLessGasFee}) with input as legacyReq with data.entities as entities
	checkGasFeeAmount({"operator": operators.lessThan, "value": legacyMoreGasFee}) with input as legacyReq with data.entities as entities
	checkGasFeeAmount({"operator": operators.greaterThanOrEqual, "value": legacyGasFee}) with input as legacyReq with data.entities as entities
	checkGasFeeAmount({"operator": operators.lessThanOrEqual, "value": legacyGasFee}) with input as legacyReq with data.entities as entities
  legacyGasFeeUsd == getGasFeeAmount("fiat:usd") with input as legacyReq with data.entities as entities
}
