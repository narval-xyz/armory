...
describe('OpenPolicyAgentEngine', () => {
  ...
  describe('scenario testing', () => {
    ...
    describe('checkIntentAmount', () => {
      ...
      it('permit a transfer of rounded 9223372036854776000 wei', async () => {
        const e = await new OpenPolicyAgentEngine({
          policies,
          entities,
          resourcePath: await getConfig('resourcePath')
      ...
      it('permit a transfer of 9223372036854775296 wei', async () => {
        const e = await new OpenPolicyAgentEngine({
          policies,
          entities,
          resourcePath: await getConfig('resourcePath')
      ...
      it('permit a transfer of 9223372036854775807, max 64-bit signed int value (inclusive)', async () => {
        const e = await new OpenPolicyAgentEngine({
          policies,
          entities,
          resourcePath: await getConfig('resourcePath')
      ...
      it('permit a transfer of 9223372036854775808, 1 above max 64-bit signed int value', async () => {
        const e = await new OpenPolicyAgentEngine({
          policies,
          entities,
          resourcePath: await getConfig('resourcePath')
