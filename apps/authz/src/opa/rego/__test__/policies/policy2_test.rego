...
test_bobCanTransferLessThanOneERC20TokenWithTwoApprovalsFromUserGroup {
	policy2_req = {
	...
	res = permit[{"policyId": "test-policy-2"}] with input as policy2_req with data.entities as policy2_entities
