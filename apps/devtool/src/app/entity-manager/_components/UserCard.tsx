  ...
  return (
    <Card>
      ...
      <div className="flex items-center gap-2">
        <CardButton icon={faWallet} onClick={onAssignAccountClick} alt="Assign accounts" />

        <CardButton icon={faIdBadge} onClick={onAddCredentialClick} alt="Add credential" />

        <CardButton icon={faEdit} onClick={onEditClick} alt="Edit user" />

        <CardButton icon={faTrash} onClick={onDeleteClick} alt="Delete user" />
      </div>
    </Card>
  )
}
