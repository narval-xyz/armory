...
const encryptedModelFields = {
  Client: [],
  ProviderConnection: [Prisma.ProviderConnectionScalarFieldEnum.credentials],
  TransitEncryptionKey: [Prisma.TransitEncryptionKeyScalarFieldEnum.privateKey]
}

const modelWithHmacIntegrity = {
  ProviderConnection: {
    [Prisma.ProviderConnectionScalarFieldEnum.id]: {
      integrity: true,
      nullable: false
    },
    [Prisma.ProviderConnectionScalarFieldEnum.clientId]: {
      integrity: true,
      nullable: false
    },
    [Prisma.ProviderConnectionScalarFieldEnum.provider]: {
      integrity: true,
      nullable: false
    },
    [Prisma.ProviderConnectionScalarFieldEnum.url]: {
      integrity: true,
      nullable: true
    },
    [Prisma.ProviderConnectionScalarFieldEnum.label]: {
      integrity: true,
      nullable: true
    },
    [Prisma.ProviderConnectionScalarFieldEnum.credentials]: {
      integrity: true,
      nullable: true
    },
    [Prisma.ProviderConnectionScalarFieldEnum.status]: {
      integrity: true,
      nullable: false
    },
    [Prisma.ProviderConnectionScalarFieldEnum.createdAt]: {
      integrity: true,
      nullable: false
    },
    [Prisma.ProviderConnectionScalarFieldEnum.updatedAt]: {
      integrity: true,
      nullable: false
    },
    [Prisma.ProviderConnectionScalarFieldEnum.revokedAt]: {
      integrity: true,
      nullable: true
    }
  }
