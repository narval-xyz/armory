...
const main = async () => {
  ...
  console.log(`\x1b[32m🚀 Approving Transfer as Player Two\x1b[0m - \x1b[36m${authId}\x1b[0m \n`)
  ...
  const authJwk = privateKeyToJwk(playerTwoPrivateKey)
  const signer = buildSignerEip191(playerTwoPrivateKey)
