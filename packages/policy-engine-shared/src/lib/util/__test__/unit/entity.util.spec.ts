import { ACCOUNT, ADDRESS_BOOK, CREDENTIAL, GROUP, TOKEN, USER } from '../../../dev.fixture.v2'
import { Entities } from '../../../schema/entity.schema.shared'
import { UserEntity, UserRole } from '../../../type/entity.type.v1'
import { populate, updateUserAccounts, validate } from '../../entity.util'
import { ACCOUNT_GROUP, USER_GROUP } from '../../../dev.fixture.v1';
